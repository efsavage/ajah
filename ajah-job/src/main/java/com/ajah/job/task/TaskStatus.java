 ...
 * 
 */
public enum TaskStatus implements IdentifiableEnum<String> {
	 ...
	 */
	public static TaskStatus get(final String string) {
		for (final TaskStatus type : values()) {
	...
	private TaskStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
