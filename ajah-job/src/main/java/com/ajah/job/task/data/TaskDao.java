...
/**
 * DAO interface for {@link Task}.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public interface TaskDao extends AjahDao<TaskId, Task> {
	 ...
	 */
	List<Task> list(final TaskType type, final TaskStatus status, final long page, final long count) throws DataOperationException;
	 ...
	 *             If the query could not be executed.
	 */
	long count(final TaskType type, final TaskStatus status) throws DataOperationException;
