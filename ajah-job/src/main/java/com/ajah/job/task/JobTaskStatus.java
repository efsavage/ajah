 ...
 * 
 */
public enum JobTaskStatus implements IdentifiableEnum<String> {
	 ...
	 */
	public static JobTaskStatus get(final String string) {
		for (final JobTaskStatus type : values()) {
	...
	private JobTaskStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
