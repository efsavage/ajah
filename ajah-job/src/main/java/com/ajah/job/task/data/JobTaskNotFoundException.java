...
/**
 * Thrown when an {@link JobTask} was expected to be found, but was not.
 * 
...
public class JobTaskNotFoundException extends Exception {
	...
	/**
	 * Thrown when an {@link JobTask} could not be found by it's internal ID.
	 * 
	 * @param id
	 *            The internal ID that was sought.
	 */
	public JobTaskNotFoundException(final JobTaskId id) {
		super("ID: " + id);
		this.id = id;
	}
