...
/**
 * Valid states of JobTask entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum JobTaskType implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a JobTaskType that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching JobTaskType, or null.
	 */
	public static JobTaskType get(final String string) {
		for (final JobTaskType type : values()) {
	...
	private JobTaskType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
