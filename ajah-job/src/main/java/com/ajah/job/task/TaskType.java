...
/**
 * Valid states of Task entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum TaskType implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a TaskType that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching TaskType, or null.
	 */
	public static TaskType get(final String string) {
		for (final TaskType type : values()) {
	...
	private TaskType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
