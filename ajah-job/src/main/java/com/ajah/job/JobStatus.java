 ...
 * 
 */
public enum JobStatus implements IdentifiableEnum<String> {
	 ...
	 */
	public static JobStatus get(final String string) {
		for (final JobStatus type : values()) {
	...
	private JobStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
