...
/**
 * Valid states of Job entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum JobType implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a JobType that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching JobType, or null.
	 */
	public static JobType get(final String string) {
		for (final JobType type : values()) {
	...
	private JobType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
