...
/**
 * A wrapper around a String for typesafe {@link Job} IDs.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
@Data
public class JobId implements Serializable, ToStringable, FromStringable, Comparable<JobId> {
	 ...
	 */
	@Override
	public int compareTo(final JobId other) {
