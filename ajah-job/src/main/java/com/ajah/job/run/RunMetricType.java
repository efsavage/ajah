...
/**
 * Valid states of RunMetric entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum RunMetricType implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a RunMetricType that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching RunMetricType, or null.
	 */
	public static RunMetricType get(final String string) {
		for (final RunMetricType type : values()) {
	...
	private RunMetricType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
