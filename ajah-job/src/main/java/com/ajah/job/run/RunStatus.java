...
public enum RunStatus implements Identifiable<String> {
	 ...
	 */
	public static RunStatus get(final String id) {
		for (final RunStatus type : values()) {
	...
	private RunStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
