...
/**
 * Valid states of RunMessage entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum RunMessageType implements IdentifiableEnum<String> {

	/**
	 * Trace.
	 */
	TRACE("0", "trace", "Trace", "Trace."),
	/**
	 * Debug.
	 */
	DEBUG("10", "debug", "Debug", "Debug."),
	/**
	 * Debug.
	 */
	INFO("20", "info", "Info", "Info."),
	/**
	 * Debug.
	 */
	WARN("30", "warn", "Warning", "Warning."),
	/**
	 * Debug.
	 */
	ERROR("40", "error", "Error", "Error.");

	/**
	 * Finds a RunMessageType that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching RunMessageType, or null.
	 */
	public static RunMessageType get(final String string) {
		for (final RunMessageType type : values()) {
	...
	private RunMessageType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
