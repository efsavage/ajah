...
public enum RunType implements Identifiable<String> {
	 ...
	 */
	public static RunType get(final String id) {
		for (final RunType type : values()) {
	...
	private RunType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
