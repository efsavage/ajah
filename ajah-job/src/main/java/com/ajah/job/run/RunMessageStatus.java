...
/**
 * Valid states of {@link RunMessage} entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum RunMessageStatus implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a RunMessageStatus that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching RunMessageStatus, or null.
	 */
	public static RunMessageStatus get(final String string) {
		for (final RunMessageStatus type : values()) {
	...
	private RunMessageStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
