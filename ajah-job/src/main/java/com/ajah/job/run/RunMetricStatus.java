...
/**
 * Valid states of {@link RunMetric} entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum RunMetricStatus implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a RunMetricStatus that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching RunMetricStatus, or null.
	 */
	public static RunMetricStatus get(final String string) {
		for (final RunMetricStatus type : values()) {
	...
	private RunMetricStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
