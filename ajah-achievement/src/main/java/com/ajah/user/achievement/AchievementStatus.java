...
/**
 * Valid states of {@link Achievement} entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum AchievementStatus implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a AchievementStatus that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching AchievementStatus, or null.
	 */
	public static AchievementStatus get(final String string) {
		for (final AchievementStatus type : values()) {
	...
	private AchievementStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
