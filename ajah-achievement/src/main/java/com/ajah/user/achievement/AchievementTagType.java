...
/**
 * Valid states of AchievementTag entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum AchievementTagType implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a AchievementTagType that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching AchievementTagType, or null.
	 */
	public static AchievementTagType get(final String string) {
		for (final AchievementTagType type : values()) {
	...
	private AchievementTagType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
