...
/**
 * Valid states of {@link AchievementTag} entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum AchievementTagStatus implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a AchievementTagStatus that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching AchievementTagStatus, or null.
	 */
	public static AchievementTagStatus get(final String string) {
		for (final AchievementTagStatus type : values()) {
