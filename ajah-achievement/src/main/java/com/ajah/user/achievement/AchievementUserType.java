...
/**
 * Valid states of AchievementUser entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum AchievementUserType implements IdentifiableEnum<String> {
	 ...
	 * @return Matching AchievementUserType, or null.
	 */
	public static AchievementUserType get(final String string) {
		for (final AchievementUserType type : values()) {
	...
	private AchievementUserType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
