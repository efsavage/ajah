...
/**
 * DAO interface for {@link Achievement}.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public interface AchievementDao extends AjahDao<AchievementId, Achievement> {
	 ...
	 */
	List<Achievement> list(final AchievementType type, final AchievementStatus status, final long page, final long count) throws DataOperationException;
	 ...
	 *             If the query could not be executed.
	 */
	long count(final AchievementType type, final AchievementStatus status) throws DataOperationException;
