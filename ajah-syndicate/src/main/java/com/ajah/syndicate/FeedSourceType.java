...
public enum FeedSourceType implements Identifiable<String> {
	 ...
	 */
	public static FeedSourceType get(final String id) {
		for (final FeedSourceType type : values()) {
	...
	private FeedSourceType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
