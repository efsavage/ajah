...
/**
 * Valid states of Day entities.
 *
 * @author Eric F. Savage <code@efsavage.com>
 *
 */
public enum ApiResponseAlertLevel implements IdentifiableEnum<String> {

	/**
	 * Informational.
	 */
	INFO("10", "info", "Information", "Informational alert."),
	/**
	 * Warning.
	 */
	WARN("20", "warn", "Warning", "A system-wide warning."),
	/**
	 * Error.
	 */
	ERROR("30", "error", "Error", "A system-wide error alert.");

	/**
	 * Finds a ApiResponseAlertType that matches the id on id, name, or name().
	 *
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching ApiResponseAlertType, or null.
	 */
	public static ApiResponseAlertLevel get(final String string) {
		for (final ApiResponseAlertLevel type : values()) {
	...
	private ApiResponseAlertLevel(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
