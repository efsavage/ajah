...
/**
 * Valid states of {@link UserFollow} entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum UserFollowStatus implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a UserFollowStatus that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching UserFollowStatus, or null.
	 */
	public static UserFollowStatus get(final String string) {
		for (final UserFollowStatus type : values()) {
	...
	private UserFollowStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
