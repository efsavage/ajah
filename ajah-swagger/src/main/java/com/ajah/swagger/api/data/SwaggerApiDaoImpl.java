...
/**
 * MySQL-based implementation of {@link SwaggerApiDao}.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
@Repository
public class SwaggerApiDaoImpl extends AbstractAjahDao<SwaggerApiId, SwaggerApi, SwaggerApi> implements SwaggerApiDao {
	...
	/**
	 * @see com.ajah.swagger.api.data.SwaggerApiDao#count(com.ajah.swagger.api.SwaggerApiType,
	 *      com.ajah.swagger.api.SwaggerApiStatus)
	 */
	@Override
	public int count(SwaggerApiType type, SwaggerApiStatus status) throws DataOperationException {
		Criteria criteria = new Criteria();
		if (type != null) {
			criteria.eq("type", type);
		}
	...
	/**
	 * @see com.ajah.swagger.api.data.SwaggerApiDao#searchCount(String,
	 *      SwaggerApiType, SwaggerApiStatus)
	 */
	@Override
