...
/**
 * Valid states of {@link SwaggerResponse} entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum SwaggerResponseStatus implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a SwaggerResponseStatus that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching SwaggerResponseStatus, or null.
	 */
	public static SwaggerResponseStatus get(final String string) {
		for (final SwaggerResponseStatus type : values()) {
	...
	private SwaggerResponseStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
