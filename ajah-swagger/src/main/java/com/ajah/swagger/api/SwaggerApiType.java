...
/**
 * Valid types of SwaggerApi entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum SwaggerApiType implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a SwaggerApiType that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching SwaggerApiType, or null.
	 */
	public static SwaggerApiType get(final String string) {
		for (final SwaggerApiType type : values()) {
	...
	private SwaggerApiType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
