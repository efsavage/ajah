...
public interface SwaggerResponseDao extends AjahDao<SwaggerResponseId, SwaggerResponse> {
	 ...
	 */
	List<SwaggerResponse> list(String search, SwaggerResponseType type, SwaggerResponseStatus status, String sort, Order order, int page, int count) throws DataOperationException;
	 ...
	 *             If the query could not be executed.
	 */
	int count(SwaggerResponseType type, SwaggerResponseStatus status) throws DataOperationException;
	 ...
	 *             If the query could not be executed.
	 */
	int searchCount(String search, SwaggerResponseType type, SwaggerResponseStatus status) throws DataOperationException;
