...
/**
 * Valid states of {@link SwaggerApi} entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum SwaggerApiStatus implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a SwaggerApiStatus that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching SwaggerApiStatus, or null.
	 */
	public static SwaggerApiStatus get(final String string) {
		for (final SwaggerApiStatus type : values()) {
	...
	private SwaggerApiStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
