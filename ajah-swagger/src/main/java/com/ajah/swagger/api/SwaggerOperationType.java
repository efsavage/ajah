...
/**
 * Valid types of SwaggerOperation entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum SwaggerOperationType implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a SwaggerOperationType that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching SwaggerOperationType, or null.
	 */
	public static SwaggerOperationType get(final String string) {
		for (final SwaggerOperationType type : values()) {
	...
	private SwaggerOperationType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
