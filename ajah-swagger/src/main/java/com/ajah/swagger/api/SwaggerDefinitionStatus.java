...
/**
 * Valid states of {@link SwaggerDefinition} entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum SwaggerDefinitionStatus implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a SwaggerDefinitionStatus that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching SwaggerDefinitionStatus, or null.
	 */
	public static SwaggerDefinitionStatus get(final String string) {
		for (final SwaggerDefinitionStatus type : values()) {
	...
	private SwaggerDefinitionStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
