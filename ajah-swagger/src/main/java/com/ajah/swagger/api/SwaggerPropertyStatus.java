...
/**
 * Valid states of {@link SwaggerProperty} entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum SwaggerPropertyStatus implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a SwaggerPropertyStatus that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching SwaggerPropertyStatus, or null.
	 */
	public static SwaggerPropertyStatus get(final String string) {
		for (final SwaggerPropertyStatus type : values()) {
	...
	private SwaggerPropertyStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
