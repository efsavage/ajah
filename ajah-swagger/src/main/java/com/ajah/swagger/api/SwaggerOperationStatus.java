...
import com.ajah.swagger.OldSwaggerOperation;
import com.ajah.util.IdentifiableEnum;

/**
 * Valid states of {@link OldSwaggerOperation} entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum SwaggerOperationStatus implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a SwaggerOperationStatus that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching SwaggerOperationStatus, or null.
	 */
	public static SwaggerOperationStatus get(final String string) {
		for (final SwaggerOperationStatus type : values()) {
	...
	private SwaggerOperationStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
