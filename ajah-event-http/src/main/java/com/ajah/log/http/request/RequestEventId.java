...
/**
 * A wrapper around a String for typesafe request event IDs.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public class RequestEventId implements Serializable, ToStringable, FromStringable, Comparable<RequestEventId> {
