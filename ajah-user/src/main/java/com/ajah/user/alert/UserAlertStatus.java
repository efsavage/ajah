...
public enum UserAlertStatus implements IdentifiableEnum<String> {
	...
	UserAlertStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
