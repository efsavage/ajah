...
/**
 * Valid states of {@link UserAlert} entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum UserAlertStatus implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a UserAlertStatus that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching UserAlertStatus, or null.
	 */
	public static UserAlertStatus get(final String string) {
		for (final UserAlertStatus type : values()) {
	...
	private UserAlertStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
