 ...
 * 
 */
public enum AccountSettingStatus implements Identifiable<String> {
	 ...
	 */
	public static AccountSettingStatus get(final String id) {
		for (final AccountSettingStatus type : values()) {
	...
	private AccountSettingStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
