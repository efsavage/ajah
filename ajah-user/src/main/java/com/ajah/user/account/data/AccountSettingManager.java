...
public class AccountSettingManager {
	 ...
	 */
	public DataOperationResult<AccountSetting> save(AccountSetting accountSetting) throws DataOperationException {
		...
		DataOperationResult<AccountSetting> result = this.accountSettingDao.update(accountSetting);
		return result;
	}
	 ...
	 */
	public AccountSetting load(AccountSettingId accountSettingId) throws DataOperationException, AccountSettingNotFoundException {
		AccountSetting accountSetting = this.accountSettingDao.load(accountSettingId);
	 ...
	 *             If the query could not be executed.
	 */
	public DataOperationResult<AccountSetting> create(String name, AccountSettingType type, AccountSettingStatus status) throws DataOperationException {
		AccountSetting accountSetting = new AccountSetting();
		accountSetting.setName(name);
		accountSetting.setType(type);
		accountSetting.setStatus(status);
		DataOperationResult<AccountSetting> result = save(accountSetting);
		return result;
	}
	 ...
	 *             If the ID specified did not match any accountSettings.
	 */
	public DataOperationResult<AccountSetting> delete(AccountSettingId accountSettingId) throws DataOperationException, AccountSettingNotFoundException {
		AccountSetting accountSetting = load(accountSettingId);
	...
	public boolean getBoolean(AccountId accountId, String name, boolean defaultValue) throws DataOperationException {
		AccountSetting accountSetting = find(accountId, name);
		if (accountSetting == null) {
			return defaultValue;
		}
	...
	private AccountSetting find(AccountId accountId, String name) throws DataOperationException {
