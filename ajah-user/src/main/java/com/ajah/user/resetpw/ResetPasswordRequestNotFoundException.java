...
/**
 * Thrown when a {@link ResetPasswordRequest} could not be found.
 * 
...
public class ResetPasswordRequestNotFoundException extends Exception {
	...
	private static final long serialVersionUID = -5182718398994759223L;

	/**
	 * Thrown when a {@link ResetPasswordRequest} could not be found by code.
	 * 
	 * @param code
