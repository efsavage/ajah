...
/**
 * Valid states of EmailVerification entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum EmailVerificationType implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a EmailVerificationType that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching EmailVerificationType, or null.
	 */
	public static EmailVerificationType get(final String string) {
		for (final EmailVerificationType type : values()) {
	...
	private EmailVerificationType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
