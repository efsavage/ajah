...
/**
 * Valid states of {@link EmailVerification} entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum EmailVerificationStatus implements IdentifiableEnum<String> {

	/**
	 * New
	 */
	NEW("0", "new", "Unsent", "Code has not been sent yet."),
	/**
	 * Sent
	 */
	SENT("1", "sent", "Sent", "Code was sent."),
	/**
	 * Error.
	 */
	ERROR("-2", "err", "Error", "Error."),
	/**
	 * Redeemed.
	 */
	REDEEEMED("2", "redeem", "Redeemed", "Code was successfully redeemed.");

	/**
	 * Finds a EmailVerificationStatus that matches the id on id, name, or
	 * name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching EmailVerificationStatus, or null.
	 */
	public static EmailVerificationStatus get(final String string) {
		for (final EmailVerificationStatus type : values()) {
