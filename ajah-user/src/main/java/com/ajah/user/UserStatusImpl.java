...
public enum UserStatusImpl implements UserStatus {
	...
	private UserStatusImpl(String id, String code, String name, String description) {
		this.id = id;
		this.code = code;
		this.name = name;
	...
	/**
	 * Finds a UserStatusImpl that matches the id on id, name, or name().
	 * 
	 * @param id
	 *            Value to match against id, name, or name()
	 * @return Matching UserStatusImpl, or null.
	 */
	public static UserStatus get(String id) {
		for (UserStatusImpl type : values()) {
