...
/**
 * Valid types of UserMemo entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum UserMemoType implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a UserMemoType that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching UserMemoType, or null.
	 */
	public static UserMemoType get(final String string) {
		for (final UserMemoType type : values()) {
	...
	private UserMemoType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
