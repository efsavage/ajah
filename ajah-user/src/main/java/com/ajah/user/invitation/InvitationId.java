...
/**
 * A wrapper around a String for typesafe {@link Invitation} IDs.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
@Data
public class InvitationId implements Serializable, ToStringable, FromStringable, Comparable<InvitationId> {
	 ...
	 */
	@Override
	public int compareTo(final InvitationId other) {
