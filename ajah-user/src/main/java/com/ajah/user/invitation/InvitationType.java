 ...
 * 
 */
public enum InvitationType implements IdentifiableEnum<String> {

	/**
	 * Invitation to sign up.
	 */
	SIGNUP("1", "signup", "Signup", "Signup.");
	 ...
	 */
	public static InvitationType get(final String string) {
		for (final InvitationType type : values()) {
	...
	private InvitationType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
