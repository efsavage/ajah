...
/**
 * Valid states of {@link Blacklist} entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum BlacklistStatus implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a BlacklistStatus that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching BlacklistStatus, or null.
	 */
	public static BlacklistStatus get(final String string) {
		for (final BlacklistStatus type : values()) {
	...
	private BlacklistStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
