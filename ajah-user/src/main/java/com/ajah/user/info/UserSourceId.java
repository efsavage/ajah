 ...
 */
@Data
public class UserSourceId implements Serializable, ToStringable, FromStringable, Comparable<UserSourceId> {
	 ...
	 */
	public UserSourceId(final String id) {
		this.id = id;
	}
	 ...
	 */
	@Override
	public int compareTo(final UserSourceId other) {
