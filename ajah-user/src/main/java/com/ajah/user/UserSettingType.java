 ...
 * 
 */
public enum UserSettingType implements Identifiable<String> {
	 ...
	 */
	public static UserSettingType get(final String id) {
		for (final UserSettingType type : values()) {
	...
	private UserSettingType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
