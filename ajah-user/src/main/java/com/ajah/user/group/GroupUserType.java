...
/**
 * Valid types of GroupUser entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum GroupUserType implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a GroupUserType that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching GroupUserType, or null.
	 */
	public static GroupUserType get(final String string) {
		for (final GroupUserType type : values()) {
	...
	private GroupUserType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
