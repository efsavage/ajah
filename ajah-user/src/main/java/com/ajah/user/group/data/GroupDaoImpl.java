 ...
 */
@Repository
public class GroupDaoImpl extends AbstractAjahDao<GroupId, Group, Group> implements GroupDao {
	...
	/**
	 * @see com.ajah.user.group.data.GroupDao#count(com.ajah.user.group.GroupType,
	 *      com.ajah.user.group.GroupStatus)
	 */
	@Override
	public int count(GroupType type, GroupStatus status) throws DataOperationException {
		Criteria criteria = new Criteria();
		if (type != null) {
			criteria.eq("type", type);
		}
	...
	/**
	 * @see com.ajah.user.group.data.GroupDao#searchCount(String,
