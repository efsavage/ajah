...
/**
 * Valid states of {@link GroupUser} entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum GroupUserStatus implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a GroupUserStatus that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching GroupUserStatus, or null.
	 */
	public static GroupUserStatus get(final String string) {
		for (final GroupUserStatus type : values()) {
	...
	private GroupUserStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
