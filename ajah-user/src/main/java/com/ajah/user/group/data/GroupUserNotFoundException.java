...
/**
 * Thrown when an {@link GroupUser} was expected to be found, but was not.
 * 
...
public class GroupUserNotFoundException extends Exception {
	...
	/**
	 * Thrown when an {@link GroupUser} could not be found by it's internal ID.
	 * 
	 * @param id
	 *            The internal ID that was sought.
	 */
	public GroupUserNotFoundException(final GroupUserId id) {
		super("ID: " + id);
		this.id = id;
	}
