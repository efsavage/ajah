...
/**
 * Valid states of {@link Group} entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum GroupStatus implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a GroupStatus that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching GroupStatus, or null.
	 */
	public static GroupStatus get(final String string) {
		for (final GroupStatus type : values()) {
