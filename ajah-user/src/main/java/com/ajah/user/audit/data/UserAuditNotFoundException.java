...
public class UserAuditNotFoundException extends Exception {

	UserAuditId id;

	/**
	 * Thrown when an {@link UserAudit} could not be found by it's internal ID.
	 * 
	 * @param id
	 *            The internal ID that was sought.
	 */
	public UserAuditNotFoundException(final UserAuditId id) {
		super("ID: " + id);
		this.id = id;
	}
