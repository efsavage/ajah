 ...
 */
@Data
public class UserAuditId implements Serializable, ToStringable, FromStringable, Comparable<UserAuditId> {
	 ...
	 */
	public UserAuditId(final String id) {
		this.id = id;
	}
	 ...
	 */
	@Override
	public int compareTo(final UserAuditId other) {
