...
/**
 * Valid states of UserSetting entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum UserSettingStatus implements Identifiable<String> {
	 ...
	 */
	public static UserSettingStatus get(final String id) {
		for (final UserSettingStatus type : values()) {
	...
	private UserSettingStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
