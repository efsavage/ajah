...
public class SignUpNotFoundException extends Exception {

	private final SignUpId id;

	/**
	 * Thrown when an {@link SignUp} could not be found by it's internal ID.
	 * 
	 * @param id
	 *            The internal ID that was sought.
	 */
	public SignUpNotFoundException(final SignUpId id) {
		super("ID: " + id);
		this.id = id;
	}
