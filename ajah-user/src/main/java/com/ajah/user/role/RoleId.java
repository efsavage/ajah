...
/**
 * A wrapper around a String for typesafe {@link Role} IDs.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
@Data
public class RoleId implements Serializable, ToStringable, FromStringable, Comparable<RoleId> {
	 ...
	 */
	@Override
	public int compareTo(final RoleId other) {
