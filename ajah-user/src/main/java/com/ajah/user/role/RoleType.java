...
/**
 * Valid types of Role entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum RoleType implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a RoleType that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching RoleType, or null.
	 */
	public static RoleType get(final String string) {
	...
	private RoleType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
