...
/**
 * Valid states of {@link GroupRole} entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum GroupRoleStatus implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a GroupRoleStatus that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching GroupRoleStatus, or null.
	 */
	public static GroupRoleStatus get(final String string) {
		for (final GroupRoleStatus type : values()) {
	...
	private GroupRoleStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
