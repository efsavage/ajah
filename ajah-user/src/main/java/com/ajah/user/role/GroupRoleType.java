...
/**
 * Valid types of GroupRole entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum GroupRoleType implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a GroupRoleType that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching GroupRoleType, or null.
	 */
	public static GroupRoleType get(final String string) {
		for (final GroupRoleType type : values()) {
	...
	private GroupRoleType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
