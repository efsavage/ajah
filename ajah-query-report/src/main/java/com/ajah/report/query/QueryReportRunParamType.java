...
/**
 * Valid types of QueryReportRunParam entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum QueryReportRunParamType implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a QueryReportRunParamType that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching QueryReportRunParamType, or null.
	 */
	public static QueryReportRunParamType get(final String string) {
		for (final QueryReportRunParamType type : values()) {
	...
	private QueryReportRunParamType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
