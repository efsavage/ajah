...
/**
 * DAO interface for {@link QueryReportRunStep}.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public interface QueryReportRunStepDao extends AjahDao<QueryReportRunStepId, QueryReportRunStep> {
	 ...
	 */
	List<QueryReportRunStep> list(String search, QueryReportRunStepType type, QueryReportRunStepStatus status, String sort, Order order, int page, int count) throws DataOperationException;
	 ...
	 *             If the query could not be executed.
	 */
	int count(QueryReportRunStepType type, QueryReportRunStepStatus status) throws DataOperationException;
	 ...
	 *             If the query could not be executed.
	 */
	int searchCount(String search, QueryReportRunStepType type, QueryReportRunStepStatus status) throws DataOperationException;
