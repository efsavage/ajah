...
/**
 * Valid states of {@link QueryReport} entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum QueryReportStatus implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a QueryReportStatus that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching QueryReportStatus, or null.
	 */
	public static QueryReportStatus get(final String string) {
		for (final QueryReportStatus type : values()) {
	...
	private QueryReportStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
