...
/**
 * Valid states of {@link QueryReportStep} entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum QueryReportStepStatus implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a QueryReportStepStatus that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching QueryReportStepStatus, or null.
	 */
	public static QueryReportStepStatus get(final String string) {
		for (final QueryReportStepStatus type : values()) {
	...
	private QueryReportStepStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
