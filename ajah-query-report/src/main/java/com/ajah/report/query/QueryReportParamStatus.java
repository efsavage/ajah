...
/**
 * Valid states of {@link QueryReportParam} entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum QueryReportParamStatus implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a QueryReportParamStatus that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching QueryReportParamStatus, or null.
	 */
	public static QueryReportParamStatus get(final String string) {
		for (final QueryReportParamStatus type : values()) {
	...
	private QueryReportParamStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
