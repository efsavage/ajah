...
/**
 * Valid types of QueryReportParam entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum QueryReportParamType implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a QueryReportParamType that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching QueryReportParamType, or null.
	 */
	public static QueryReportParamType get(final String string) {
		for (final QueryReportParamType type : values()) {
	...
	private QueryReportParamType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
