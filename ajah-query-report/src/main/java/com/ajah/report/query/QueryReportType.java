...
/**
 * Valid types of QueryReport entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum QueryReportType implements IdentifiableEnum<String> {
	 ...
	 */
	public static QueryReportType get(final String string) {
		for (final QueryReportType type : values()) {
	...
	private QueryReportType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
