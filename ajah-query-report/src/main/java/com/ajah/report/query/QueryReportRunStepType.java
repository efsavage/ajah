...
/**
 * Valid types of QueryReportRunStep entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum QueryReportRunStepType implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a QueryReportRunStepType that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching QueryReportRunStepType, or null.
	 */
	public static QueryReportRunStepType get(final String string) {
		for (final QueryReportRunStepType type : values()) {
	...
	private QueryReportRunStepType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
