...
/**
 * Valid types of QueryReportRun entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum QueryReportRunType implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a QueryReportRunType that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching QueryReportRunType, or null.
	 */
	public static QueryReportRunType get(final String string) {
		for (final QueryReportRunType type : values()) {
	...
	private QueryReportRunType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
