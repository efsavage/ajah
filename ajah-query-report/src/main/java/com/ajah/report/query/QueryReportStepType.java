...
/**
 * Valid types of QueryReportStep entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum QueryReportStepType implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a QueryReportStepType that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching QueryReportStepType, or null.
	 */
	public static QueryReportStepType get(final String string) {
		for (final QueryReportStepType type : values()) {
	...
	private QueryReportStepType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
