 ...
 * 
 */
public interface QueryReportDao extends AjahDao<QueryReportId, QueryReport> {
	 ...
	 */
	List<QueryReport> list(String search, QueryReportType type, QueryReportStatus status, String sort, Order order, int page, int count) throws DataOperationException;
	 ...
	 *             If the query could not be executed.
	 */
	int count(QueryReportType type, QueryReportStatus status) throws DataOperationException;
	 ...
	 *             If the query could not be executed.
	 */
	int searchCount(String search, QueryReportType type, QueryReportStatus status) throws DataOperationException;
