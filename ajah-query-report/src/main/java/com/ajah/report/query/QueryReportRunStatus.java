...
/**
 * Valid states of {@link QueryReportRun} entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum QueryReportRunStatus implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a QueryReportRunStatus that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching QueryReportRunStatus, or null.
	 */
	public static QueryReportRunStatus get(final String string) {
		for (final QueryReportRunStatus type : values()) {
	...
	private QueryReportRunStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
