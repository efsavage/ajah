...
/**
 * Valid states of {@link QueryReportRunParam} entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum QueryReportRunParamStatus implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a QueryReportRunParamStatus that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching QueryReportRunParamStatus, or null.
	 */
	public static QueryReportRunParamStatus get(final String string) {
		for (final QueryReportRunParamStatus type : values()) {
	...
	private QueryReportRunParamStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
