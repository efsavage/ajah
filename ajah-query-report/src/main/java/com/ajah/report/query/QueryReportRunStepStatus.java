...
/**
 * Valid states of {@link QueryReportRunStep} entities.
 * 
...
public enum QueryReportRunStepStatus implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a QueryReportRunStepStatus that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching QueryReportRunStepStatus, or null.
	 */
	public static QueryReportRunStepStatus get(final String string) {
		for (final QueryReportRunStepStatus type : values()) {
	...
	private QueryReportRunStepStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
