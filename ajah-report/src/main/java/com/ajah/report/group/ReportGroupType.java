...
/**
 * Valid types of ReportGroup entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum ReportGroupType implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a ReportGroupType that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching ReportGroupType, or null.
	 */
	public static ReportGroupType get(final String string) {
		for (final ReportGroupType type : values()) {
	...
	private ReportGroupType(final String id, final String code, final String name, final String description) {
		this.id = id;
		this.code = code;
		this.name = name;
