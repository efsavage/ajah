 ...
 */
package com.ajah.report.group;

import com.ajah.util.IdentifiableEnum;

/**
 * Valid states of {@link ReportGroup} entities.
 * 
 * @author Eric F. Savage <code@efsavage.com>
 * 
 */
public enum ReportGroupStatus implements IdentifiableEnum<String> {
	...
	/**
	 * Finds a ReportGroupStatus that matches the id on id, name, or name().
	 * 
	 * @param string
	 *            Value to match against id, name, or name()
	 * @return Matching ReportGroupStatus, or null.
	 */
	public static ReportGroupStatus get(final String string) {
		for (final ReportGroupStatus type : values()) {
	...
	private ReportGroupStatus(final String id, final String code, final String name, final String description, final boolean active, final boolean error, final boolean deleted) {
		this.id = id;
		this.code = code;
		this.name = name;
