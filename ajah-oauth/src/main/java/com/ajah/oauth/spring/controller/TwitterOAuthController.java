...
@Controller
@Slf4j
public class TwitterOAuthController extends OAuthController {
	...
	public String twitter(@RequestParam("oauth_token") final String oauthToken, @RequestParam("oauth_verifier") final String oauthVerifier, final HttpServletRequest request)
		...
		final String successUrl = this.oAuthTokenManager.verify(getUser(request), oauthToken, oauthVerifier, this.twitterService);
