...
/**
 * Sets a X-Content-Type-Options based on the "ajah.header.content-type-options"
 * property. Default value is "nosniff" (the only known supported value).
 * 
...
public class ContentTypeOptionsFilter extends BaseFilter {
